...
public interface IUserMapper {
	 ...
	 */
	@Update("UPDATE USER SET PASSWORD=#{password},MODIFIED_USER=#{modifiedUser},MODIFIED_TIME=#{modifiedTime} WHERE ID=#{id}")
	...
	@Select("SELECT ID,NAME,PASSWORD,DEPARTMENTCODE,CREATED_USER CREATEDUSER,CREATED_TIME CREATEDTIME,"
			+ "MODIFIED_USER MODIFIEDUSER,MODIFIED_TIME MODIFIEDTIME FROM USER WHERE NAME=#{name}")
